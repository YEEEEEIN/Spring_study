...
public class ExampleController12 {
	...
	name - 매트릭스 변수 이름
	pathVar - 매트릭스 변수가 있는 URI 경로 변수 이름
	required - 매트릭스 변수가 요구되는지 여부
	value - 매트릭스 변수 'name-value'에서 name에 해당하는 영역
	*/
	
	// /exam12/abcd1234;publisher=네이버;name=광마회귀/category/무협지;publisher=카카오;author=둘리작가
	...
	public String requestMethod
		...
		model.addAttribute("data1", matrixVars + "<br>" + matrixVars2 + "<br>" + matrixVars3);
